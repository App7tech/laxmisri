<footer class="b-footer_container color-scheme-light hidden -sm-down ">
    <div class="container b-main_footer">
        ...
        <aside class="row clearfix">
            ...
            <div class="b-footer_column col-lg-4 col-md-3 col-sm-6 mb-4 align-middle">
                <div class="b-footer_block">
                    ...
                    <div class="b-footer_block_in">
                        ...
                        <ul class="b-footer_menu">
                            ...
                            <li><a href="#">Kankatala</a></li>
                            <li><a href="#">Novtel</a></li>
                            <li><a href="#">Jagadamba</a></li>
            ...
            <div class="b-footer_column col-lg-4 col-md-3 col-sm-6 mb-4">
                <div class="b-footer_block">
                ...
                <div class="b-footer_block">
                    ...
                    <div class="b-footer_block_in">
                        ...
                        <div class="b-contact_info">
                            ...
                            <i class="fa fa-location-arrow d-inline-block"></i> # 15-8-431/1&2, Opp.Santhoshi Matha Temple, New Feelkhana, Begum Bazar, Hyderabad.
                            <br>
                            <i class="fa fa-mobile d-inline-block"></i> Phone: +91 9949551967, +91 9949551968
                                                                                
                            <br> 
                            <i class="fa fa-envelope-open d-inline-block"></i>  Email: laxmisriart2@gmail.com
                        </div>
                        <br>
        ...
        <div class="container">
            <div class="d-footer_bar">
                <div class="text-center">
                    Laxmi Sri Art Jewellers <i class="fa fa-copyright"></i> 2019 Created by 
                    <a href="#" class="text-white">
                        <a href="http://app7tech.com/">App7tech IT Solutions</a>
                    </a> 
                </div>
            </div>
        </div>
